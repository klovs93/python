...
first_alpha = secret_message[0][3]
second_alpha = secret_message[1][9:13]
third_alpha = secret_message[2][5:15:2]
four_alpha = (secret_message[3][7:13])[::-1]
five_alpha = (secret_message[4][16:21])[::-1]
print(first_alpha,second_alpha,third_alpha,four_alpha,five_alpha)
